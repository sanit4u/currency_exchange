...
import de.sanit4u.test.check.config.SchedulerConfig;
import de.sanit4u.test.check.config.TestConfig;
import de.sanit4u.test.check.model.CurrencyExchangeRate;
import de.sanit4u.test.check.scheduler.CheckServiceScheduler;
