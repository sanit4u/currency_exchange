package de.sanit4u.test.exchange.config;
...
import de.sanit4u.test.exchange.util.Constants;
...
public class SwaggerConfig {
	...
	public Docket productApi() {
		Docket docket = new Docket(DocumentationType.SWAGGER_2).apiInfo(metaInfo()).pathMapping("/")
