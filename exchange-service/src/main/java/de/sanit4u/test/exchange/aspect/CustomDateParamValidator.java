package de.sanit4u.test.exchange.aspect;
...
import de.sanit4u.test.exchange.exception.InvalidInputException;
...
public class CustomDateParamValidator {
	...
	@Around("@annotation(de.sanit4u.test.exchange.aspect.CustomDateParams)")
